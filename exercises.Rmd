...
- [ ]  It is not possible to know if a patient has high risk neuroblastoma disease without doing a FISH and understanding if the person has MYCN amplification
...
Write the command to input the patient information to R. This can be done in groups.
...
Write the command to predict the high risk label for the patient based in the patient's gene expression pattern. This can be done in groups.
